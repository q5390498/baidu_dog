...
if os.path.exists('dog_single_vgg16.h5'):
    ...
    model.fit_generator(generator=train_generator, steps_per_epoch=200, epochs=100,validation_data=val_generator,validation_steps=20, callbacks=[early_stopping])
...
model.compile(optimizer=SGD(lr= 0.001, momentum=0.9), loss={'prob':'categorical_crossentropy'}, metrics=['accuracy'])
